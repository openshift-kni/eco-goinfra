...
func TestNewPreflightValidationBuilder(t *testing.T) {
	testCases := []struct {
		name              string
		namespace         string
		expectedPreflight *v1beta2.PreflightValidation
		expectedErr       string
	}{
		{
...
func buildDummyPreflight() []runtime.Object {
	return append([]runtime.Object{}, &v1beta2.PreflightValidation{
		ObjectMeta: metav1.ObjectMeta{
			Name:      defaultPreflightName,
			Namespace: defaultPreflightNamespace,
		},
...
func generatePreflight(name, nsname string) *v1beta2.PreflightValidation {
	return &v1beta2.PreflightValidation{
		ObjectMeta: metav1.ObjectMeta{
			Name:      name,
			Namespace: nsname,
		},
