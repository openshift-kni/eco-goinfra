...
require (
	...
	github.com/stolostron/backplane-operator v0.0.0-20240514151010-aabc8a9b7ad7
...
replace github.com/openshift/hive/apis => github.com/openshift/hive/apis v0.0.0-20220707210052-4804c09ccc5a
