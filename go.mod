...
require (
	...
	github.com/openshift/cluster-logging-operator v0.0.0-20240103194754-e79dd6540d8f
	...
	github.com/openshift/local-storage-operator v0.0.0-20231220121151-4e580bd14c46
